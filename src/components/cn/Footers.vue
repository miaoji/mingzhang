		...
		<div class="footer_main w">
			<ul class="clear">
				<li class="left">
					...
					<div class="footer_item"><router-link to="/cn/question">疑难解答</router-link></div>
					<div class="footer_item"><router-link to="/cn/violate">禁运物品</router-link></div>
				</li>
				<li class="left">
					<div class="tit">关于我们</div>
					<div class="footer_item"><router-link to="/cn/introduce">公司介绍</router-link></div>
				</li>
				<li class="left">
