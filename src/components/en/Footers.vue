<template>
	<div class="footer">
		...
		<div class="footer_ico"><img src="/static/image/footer_ico.png" alt="footer_ico"></div>
		<div class="footer_main w">
			<ul class="clear">
				<li class="left">
					<div class="tit">Help&Support</div>
					<div class="footer_item"><router-link to="/en/question">Questions & Answers</router-link></div>
					<div class="footer_item"><router-link to="/en/violate">Prohibited Articles</router-link></div>
				</li>
				<li class="left">
					<div class="tit">About us</div>
					<div class="footer_item"><router-link to="/en/introduce">Company Profile</router-link></div>
				</li>
				<li class="left">
			...
			<div class="footer_info">沪ICP备17039232号-1</div>
		</div>
	</div>
</template>
<script>
...
.footer_line{
	...
	border-top: 1px solid #f4c0c7;
	border-bottom: 1px solid #a9182d;
}
.footer{
	position: relative;
...
.footer>.footer_main>ul>li>.footer_item{
	font-size: 13px;
	color: #999999;
	line-height: 1.5em;
}
