					...
					<el-row :gutter="12">
						<el-col :span="5">
							<el-form-item label="包裹重量(kg) : ">
								<el-input-number v-model="form.weight" controls-position="right" :step='1' @change="weightChange" :min="0" :max="20"/>
							</el-form-item>
						</el-col>
						<el-col :span="5" :offset="6">
							<el-form-item label="包裹长度(cm) : ">
								<el-input-number v-model="form.length" controls-position="right" :step='10' @change="lengthChange" :min="0"/>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row :gutter="12">
						<el-col :span="5">
							...
							<el-form-item label="包裹宽度(cm) : ">
								<el-input-number v-model="form.width" controls-position="right" :step='10' @change="widthChange" :min="0"/>
							</el-form-item>
						</el-col>
						<el-col :span="5" :offset="6">
							<el-form-item label="包裹高度(cm) : ">
								<el-input-number v-model="form.height" controls-position="right" :step='10' @change="heightChange" :min="0"/>
							</el-form-item>
